...
module VC0_fifo_synth(clk, reset, wr_enable, rd_enable, data_in, init, Umbral_VC0, full_fifo_VC0, empty_fifo_VC0, almost_full_fifo_VC0, almost_empty_fifo_VC0, error_VC0, data_out_VC0);
  ...
  (* src = "./initial_logic_synth/VC0_fifo_synth.v:24" *)
  wire [31:0] i;
  (* src = "./initial_logic_synth/VC0_fifo_synth.v:7" *)
  input [5:0] init;
  wire [5:0] \mem[0] ;
...
module VC1_fifo_synth(clk, reset, wr_enable, rd_enable, init, data_in, Umbral_VC1, full_fifo_VC1, empty_fifo_VC1, almost_full_fifo_VC1, almost_empty_fifo_VC1, error_VC1, data_out_VC1);
  ...
  (* src = "./initial_logic_synth/VC1_fifo_synth.v:24" *)
  wire [31:0] i;
  (* src = "./initial_logic_synth/VC1_fifo_synth.v:6" *)
  input init;
  wire [5:0] \mem[0] ;
...
module final_logic_synth(data_out_VC0, data_out_VC1, clk, reset_L, empty_fifo_VC0, empty_fifo_VC1, init, D0_pop, D1_pop, Umbral_D0, Umbral_D1, data_out_D0_synth, data_out_D1_synth, pop_VC0_fifo_synth, pop_VC1_fifo_synth, error_D1_synth, error_D0_synth, empty_fifo_D1_synth, empty_fifo_D0_synth);
...
module full_logic_synth(clk, reset, wr_enable, data_in, D0_pop, D1_pop, Umbral_Main, Umbral_VC0, Umbral_VC1, Umbral_D0, Umbral_D1, init, umbral_MFs, umbral_VCs, umbral_Ds, data_out_D0_synth, data_out_D1_synth, error_D0_synth, error_D1_synth, error_out, active_out, idle_out, empty_fifo_D0_synth, empty_fifo_D1_synth);
...
module initial_logic_synth(clk, reset, wr_enable, init, data_in, pop_VC0_fifo_synth, pop_VC1_fifo_synth, Umbral_Main, Umbral_VC0, Umbral_VC1, error_main, empty_main_fifo, full_fifo_VC0, empty_fifo_VC0, almost_full_fifo_VC0, almost_empty_fifo_VC0, error_VC0, data_out_VC0, full_fifo_VC1, empty_fifo_VC1, almost_full_fifo_VC1, almost_empty_fifo_VC1, error_VC1, data_out_VC1);
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "./initial_logic_synth/initial_logic_synth.v:64" *)
