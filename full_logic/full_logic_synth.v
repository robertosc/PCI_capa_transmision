...
module arbitro_enrutamiento_synth(VC0, VC1, data_arbitro_VC0, data_arbitro_VC1, clk, reset_L, almost_full_fifo_D0, almost_full_fifo_D1, full_fifo_D0, full_fifo_D1, VC0_empty, VC1_empty, VC1_pop, VC0_pop, D0_push, D1_push, arbitro_D0_out, arbitro_D1_out);
  ...
  retraso1_synth retraso1_syntha (
    ...
    .VC0_retrasado(VC0_retrasado),
    .VC1(VC1),
    .VC1_empty(VC1_empty),
    .VC1_empty_retrasado(VC1_empty_retrasado),
    .VC1_retrasado(VC1_retrasado),
    .clk(clk),
...
module arbitro_mux_synth(reset_L, clk, VC0, VC1, pop_delay_VC0, pop_delay_VC1, VC0_empty, VC1_empty, arbitro_D0_out, arbitro_D1_out, D0_push, D1_push);
  ...
  assign arbitro_D1_out[4] = D1_push;
endmodule
...
module retraso1_synth(reset_L, clk, VC0, VC1, pop_delay_VC0, pop_delay_VC1, VC0_empty, VC1_empty, VC0_empty_retrasado, VC1_empty_retrasado, VC0_retrasado, VC1_retrasado);
  (* src = "./arbitro_mux_synthes/retraso1_synth.v:2" *)
  input [5:0] VC0;
  (* src = "./arbitro_mux_synthes/retraso1_synth.v:5" *)
  input VC0_empty;
  (* src = "./arbitro_mux_synthes/retraso1_synth.v:6" *)
  output VC0_empty_retrasado;
  (* src = "./arbitro_mux_synthes/retraso1_synth.v:7" *)
  output [5:0] VC0_retrasado;
  ...
  (* src = "./arbitro_mux_synthes/retraso1_synth.v:1" *)
  input reset_L;
  (* src = "./arbitro_mux_synthes/retraso1_synth.v:11" *)
  DFF _00_ (
    .C(clk),
    .D(VC1_empty),
